...
return [
    'users' => [
        'sessions' => [
            ...
            'password' => 'Пароль',
            'powered-by-description' => 'Работает на MEANLY, проект с открытым исходным кодом.',
            'submit-btn' => 'Войти',
            'title' => 'Войти',
        ],
    ...
    'dashboard' => [
        'index' => [
            ...
            'decreased' => ':progress%',
            'empty-threshold' => 'Минимальный остаток',
    ...
    'sales' => [
        'orders' => [
            ...
            'create' => [
                ...
                'order-placed-success' => 'Заказ успешно оформлен.',
    ...
    'catalog' => [
        ...
        'categories' => [
            ...
            'create' => [
                ...
                'settings' => 'Настройки',
                'slug' => 'Slug',
                'show-in-header' => 'Показывать в шапке',
                'show-in-push-menu' => 'Показать в боковом меню',
                'show-in-carousel' => 'Показывать в карусели',
                'title' => 'Добавить новую категорию',
                'visible-in-menu' => 'Статус',
            ],
