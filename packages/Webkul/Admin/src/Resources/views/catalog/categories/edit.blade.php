            ...
            <div class="flex w-[360px] max-w-full flex-col gap-2">
                ...
                <x-admin::accordion>
                    ...
                    <x-slot:content>
                        ...
                        <x-admin::form.control-group>
                            <x-admin::form.control-group.label>
                                @lang('admin::app.catalog.categories.edit.show-in-header')
                            </x-admin::form.control-group.label>

                            @php $selectedValue = old('show_in_header') ?: $category->show_in_header @endphp
                            ...
                            <x-admin::form.control-group.control
                                ...
                                name="show_in_header"
                                value="1"
                                :label="trans('admin::app.catalog.categories.edit.show-in-header')"
                                :checked="(boolean) $selectedValue"
                            />
                        </x-admin::form.control-group>
                        ...
                        <x-admin::form.control-group>
                            <x-admin::form.control-group.label>
                                @lang('admin::app.catalog.categories.edit.show-in-carousel')
                            </x-admin::form.control-group.label>

                            @php $selectedValue = old('show_in_carousel') ?: $category->show_in_carousel @endphp
                            ...
                            <x-admin::form.control-group.control
                                ...
                                name="show_in_carousel"
                                value="1"
                                :label="trans('admin::app.catalog.categories.edit.show-in-carousel')"
                                :checked="(boolean) $selectedValue"
                            />
                        </x-admin::form.control-group>
                        ...
                        <x-admin::form.control-group>
                            <x-admin::form.control-group.label>
                                @lang('admin::app.catalog.categories.edit.show-in-push-menu')
                            </x-admin::form.control-group.label>

                            @php $selectedValue = old('show_in_push_menu') ?: $category->show_in_push_menu @endphp

                            <x-admin::form.control-group.control
                                type="hidden"
                                name="show_in_push_menu"
                                :checked="(boolean) $selectedValue"
                            />
                            ...
                            <x-admin::form.control-group.control
                                ...
                                name="show_in_push_menu"
                                value="1"
                                :label="trans('admin::app.catalog.categories.edit.show-in-push-menu')"
                                :checked="(boolean) $selectedValue"
                            />
                        </x-admin::form.control-group>
