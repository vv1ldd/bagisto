            ...
            <div class="flex w-[360px] max-w-full flex-col gap-2">
                ...
                <x-admin::accordion>
                    ...
                    <x-slot:content>
                        ...
                        <x-admin::form.control-group>
                            <x-admin::form.control-group.label>
                                @lang('admin::app.catalog.categories.create.show-in-header')
                            </x-admin::form.control-group.label>
                            ...
                            <x-admin::form.control-group.control
                                ...
                                name="show_in_header"
                                value="1"
                                :label="trans('admin::app.catalog.categories.create.show-in-header')"
                            />
                        </x-admin::form.control-group>
                        ...
                        <x-admin::form.control-group>
                            <x-admin::form.control-group.label>
                                @lang('admin::app.catalog.categories.create.show-in-carousel')
                            </x-admin::form.control-group.label>
                            ...
                            <x-admin::form.control-group.control
                                ...
                                value="1"
                                :label="trans('admin::app.catalog.categories.create.show-in-carousel')"
                            />
                        </x-admin::form.control-group>
                        ...
                        <x-admin::form.control-group>
                            <x-admin::form.control-group.label>
                                @lang('admin::app.catalog.categories.create.show-in-push-menu')
                            </x-admin::form.control-group.label>
                            ...
                            <x-admin::form.control-group.control
                                ...
                                value="1"
                                :label="trans('admin::app.catalog.categories.create.show-in-push-menu')"
                            />
                        </x-admin::form.control-group>
