        ...
        <div style="padding: 20px; background-color: #F0EFFF; border: 3px solid #18181B; margin-bottom: 34px;">
            <p style="font-size: 16px; color: #18181B; line-height: 24px; margin: 0;">
                @lang('admin::app.emails.orders.invoiced.greeting', [
                    ...
                    'order_id'   => '<a href="' . route('admin.sales.orders.view', $invoice->order_id) . '" style="color: #7C45F5; font-weight: 900; text-underline-offset: 4px;">#' . $invoice->order->increment_id . '</a>',
                        ...
                        <table style="width: 100%; font-size: 15px; color: #18181B; line-height: 30px;">
                            @if (core()->getConfigData('sales.taxes.sales.display_subtotal') == 'including_tax')
                                <tr>
                                    ...
                                    <td style="text-align: right; padding-bottom: 8px; font-weight: 700;">{{ core()->formatBasePrice($invoice->base_sub_total_incl_tax) }}</td>
                                </tr>
                            @elseif (core()->getConfigData('sales.taxes.sales.display_subtotal') == 'both')
                                <tr>
                                    <td>@lang('admin::app.emails.orders.subtotal-excl-tax')</td>
                                    <td style="text-align: right; font-weight: 700;">{{ core()->formatBasePrice($invoice->base_sub_total) }}</td>
                                </tr>
                                <tr>
                            ...
                            @else
                                <tr>
                                    <td style="padding-bottom: 8px;">@lang('admin::app.emails.orders.subtotal')</td>
                                    <td style="text-align: right; padding-bottom: 8px; font-weight: 700;">{{ core()->formatBasePrice($invoice->base_sub_total) }}</td>
                                </tr>
                            @endif
                            ...
                            @if ($invoice->order->shipping_address)
                                @if (core()->getConfigData('sales.taxes.sales.display_shipping_amount') == 'including_tax')
                                    <tr>
                                        ...
                                        <td style="text-align: right; padding-bottom: 8px; font-weight: 700;">{{ core()->formatBasePrice($invoice->base_shipping_amount_incl_tax) }}</td>
                                    </tr>
                                @elseif (core()->getConfigData('sales.taxes.sales.display_shipping_amount') == 'both')
                                    <tr>
                                        <td>@lang('admin::app.emails.orders.shipping-handling-excl-tax')</td>
                                        <td style="text-align: right; font-weight: 700;">{{ core()->formatBasePrice($invoice->base_shipping_amount) }}</td>
                                    </tr>
                                    <tr>
                                ...
                                @else
                                    <tr>
                                        <td style="padding-bottom: 8px;">@lang('admin::app.emails.orders.shipping-handling')</td>
                                        <td style="text-align: right; padding-bottom: 8px; font-weight: 700;">{{ core()->formatBasePrice($invoice->base_shipping_amount) }}</td>
                                    </tr>
                                @endif
                            @endif
                            ...
                            <tr>
                                ...
                                <td style="text-align: right; padding-bottom: 8px; font-weight: 700;">{{ core()->formatBasePrice($invoice->base_tax_amount) }}</td>
                            </tr>

                            @if ($invoice->discount_amount > 0)
                                <tr>
                                    <td style="padding-bottom: 8px;">@lang('admin::app.emails.orders.discount')</td>
                                    <td style="text-align: right; padding-bottom: 8px; font-weight: 700;">-{{ core()->formatBasePrice($invoice->base_discount_amount) }}</td>
                                </tr>
                            @endif
                                    ...
                                    <div style="background-color: #7C45F5; color: #FFFFFF; padding: 16px; border: 3px solid #18181B; box-shadow: 4px 4px 0px 0px #18181B;">
                                        <table style="width: 100%; border-collapse: collapse;">
                                            <tr>
                                                ...
                                                <td style="text-align: right; font-weight: 900; font-size: 20px;">{{ core()->formatBasePrice($invoice->base_grand_total) }}</td>
                                            </tr>
                                        </table>
                                    </div>
                                </td>
