                    ...
                    <x-slot:content>
                        ...
                        <div class="flex gap-4 max-sm:flex-wrap">
                            ...
                            <x-admin::form.control-group class="mb-2.5 w-full">
                                ...
                                <x-admin::form.control-group.control type="text" name="first_name" id="first_name"
                                    ::value="customer.first_name" rules="required"
                            ...
                            <x-admin::form.control-group class="mb-2.5 w-full">
                                ...
                                <x-admin::form.control-group.control type="text" name="last_name"
                                    ::value="customer.last_name" id="last_name" rules="required"
                        ...
                        <x-admin::form.control-group>
                            ...
                            <x-admin::form.control-group.control type="email" name="email" ::value="customer.email"
                        ...
                        <div class="flex gap-4 max-sm:flex-wrap">
                            ...
                            <x-admin::form.control-group class="mb-2.5 w-full">
                                ...
                                <x-admin::form.control-group.control type="text" name="phone" ::value="customer.phone"
                            ...
                            <x-admin::form.control-group class="mb-2.5 w-full">
                                ...
                                <x-admin::form.control-group.control type="date" name="date_of_birth" id="dob"
                        ...
                        <div class="flex gap-4 max-sm:flex-wrap">
                            ...
                            <x-admin::form.control-group class="w-full">
                                ...
                                <x-admin::form.control-group.control type="select" name="gender" ::value="customer.gender"
                            ...
                            <x-admin::form.control-group class="w-full">
                                ...
                                <x-admin::form.control-group.control type="select" name="customer_group_id"
                                    ::value="customer.customer_group_id" id="customerGroup"
                        ...
                        <div class="flex flex-wrap gap-6 max-sm:flex-wrap">
                            ...
                            <x-admin::form.control-group class="!mb-0">
                                ...
                                <x-admin::form.control-group.control type="hidden" name="is_suspended" value="0" />

                                <x-admin::form.control-group.control type="switch" name="is_suspended" :value="1"
                        ...
                        <x-slot:footer>
                            <!-- Save Button -->
                            <x-admin::button button-type="submit" class="primary-button justify-center"
                                :title="trans('admin::app.customers.customers.view.edit.save-btn')" ::loading="isLoading"
                                ::disabled="isLoading" />
                            </x-slot>
            </x-admin::modal>
        </form>
