                    ...
                    <div class="box-shadow rounded bg-white p-4 dark:bg-gray-900">
                        ...
                        <x-admin::form.control-group class="!mb-0">
                            <x-admin::form.control-group.label class="required">
                                @lang('magic_ai::app.knowledge_base.create.content')
                            </x-admin::form.control-group.label>

                            <x-admin::form.control-group.control type="textarea" name="content" rules="required"
                                :value="old('content')" :label="trans('magic_ai::app.knowledge_base.create.content')"
                                :placeholder="trans('magic_ai::app.knowledge_base.create.content')" rows="10" />
