...
return [
    ...
    */
    ...
    [
        ...
        'name' => 'admin::app.acl.billing-entities',
        'route' => 'admin.settings.billing_entities.index',
        'sort' => 10,
    ],
    [
        'key' => 'settings.billing_entities.create',
        'name' => 'admin::app.acl.create',
        'route' => 'admin.settings.billing_entities.store',
        'sort' => 1,
    ],
    [
        'key' => 'settings.billing_entities.edit',
        'name' => 'admin::app.acl.edit',
        'route' => 'admin.settings.billing_entities.edit',
        'sort' => 2,
    ],
    [
        'key' => 'settings.billing_entities.delete',
        'name' => 'admin::app.acl.delete',
        'route' => 'admin.settings.billing_entities.delete',
        'sort' => 3,
    ],
    [
