...
return [
    ...
    [
        'key' => 'general.design.copyright',
        'name' => 'Футер (Копирайт)',
        'info' => 'Настройка текста копирайта в самом низу страницы',
        'sort' => 4,
        'fields' => [
            [
                'name'          => 'copyright_text',
                ...
                'type'          => 'textarea',
                'default'       => '© :year :company. All rights reserved. All trademarks are property of their respective owners.',
                'channel_based' => true,
                'locale_based'  => true,
            ],
        ],
    ...
    [
        'key' => 'sales.payment_methods.credits',
        'name' => 'Meanly Pay',
        'info' => 'Оплата кошельком Meanly Pay',
        'sort' => 2,
        'fields' => [
            [
                'name' => 'title',
    ...
    [
        'key' => 'sales.payment_methods.sbp',
        'name' => 'SBP (Система быстрых платежей)',
        'info' => 'Настройки оплаты через СБП',
        'sort' => 3,
        'fields' => [
            [
                'name' => 'title',
                ...
                'channel_based' => true,
                'locale_based' => true,
                'default_value' => 'СБП (Система быстрых платежей)',
            ],
            [
                'name' => 'description',
                'title' => 'admin::app.configuration.index.sales.payment-methods.description',
            ...
            [
                'name' => 'test_mode',
                'title' => 'Тестовый режим (Simulate)',
                'type' => 'boolean',
                'default_value' => false,
                'channel_based' => true,
                'locale_based' => false,
                'info' => 'Включает кнопку симуляции на странице оплаты',
            ],
            [
                'name' => 'sort',
                'title' => 'admin::app.configuration.index.sales.payment-methods.sort-order',
    ...
    [
        ...
        'fields' => [
            ...
            [
                ...
                'type' => 'text',
                'default' => 'shop::app.checkout.cart.mini-cart.offer-on-orders',
                'validation' => 'max:200',
                'channel_based' => true,
                'locale_based' => true,
            ],
