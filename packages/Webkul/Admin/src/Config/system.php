...
return [
    ...
    [
        ...
        'info' => 'Отображение контактов и реквизитов в подвале сайта',
        'sort' => 3,
        'fields' => [
            [
