...
class PasskeyController extends Controller
{
    ...
    private function generateTargetedPasskeyOptions($customer, $generateOptionsAction)
    {
        ...
        try {
            ...
            Log::debug("Passkey: Targeted options generated in controller", [
            ...
            Log::error("Passkey: Failed to generate targeted options in controller", ['error' => $e->getMessage()]);
            return $optionsJson; // Fallback to discovery
        }
    }
