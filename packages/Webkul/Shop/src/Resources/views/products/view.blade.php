                                                                        ...
                                                                        >
                                                                            ...
                                                                            >
                                                                                ...
                                                                                <div class="container px-4 lg:px-8 max-1180:px-0">
                                                                                        ...
                                                                                        <div class="flex items-start gap-6 mb-10 bg-white/40 backdrop-blur-md rounded-3xl p-6 border border-white/60 shadow-sm w-fit max-sm:gap-4 max-sm:p-4 max-sm:rounded-2xl">
                                                                                            ...
                                                                                            <div class="flex flex-col justify-center">
                                                                                                ...
                                                                                                <div class="mt-2 text-sm text-zinc-500 line-clamp-2 max-w-[400px] max-sm:hidden">
