        ...
        <div style="padding: 20px; background-color: #F0EFFF; border: 3px solid #18181B; margin-bottom: 34px;">
            <p style="font-size: 16px; color: #18181B; line-height: 24px; margin: 0;">
                @lang('shop::app.emails.orders.shipped.greeting', [
                    ...
                    'order_id'   => '<a href="' . route('shop.customers.account.orders.view', $shipment->order_id) . '" style="color: #7C45F5; font-weight: 900; text-underline-offset: 4px;">#' . $shipment->order->increment_id . '</a>',
                        ...
                        <div style="padding: 24px; background-color: #FFFFFF; border: 3px solid #18181B; box-shadow: 8px 8px 0px 0px #F0EFFF; min-height: 350px;">
                            ...
                            <div style="margin-top: 24px;">
                                ...
                                <div style="font-size: 13px; color: #18181B; margin-top: 12px; line-height: 1.6;">
                                    <span style="font-weight: 700;">@lang('shop::app.emails.orders.carrier'):</span> {{ $shipment->carrier_title }}<br>
                                    <span style="font-weight: 700;">@lang('shop::app.emails.orders.tracking-number', ['tracking_number' =>  $shipment->track_number])</span>
                                </div>
                            </div>
                        </div>
                    </td>
                    ...
                    <tr style="border-bottom: 1px solid #18181B;">
                        ...
                        <td style="padding: 16px; font-size: 14px; color: #18181B;">
                            ...
                            @elseif (core()->getConfigData('sales.taxes.sales.display_prices') == 'both')
                                {{ core()->formatPrice($item->price_incl_tax, $shipment->order->order_currency_code) }}
                                <br><span style="font-size: 11px; opacity: 0.7;">@lang('shop::app.emails.orders.excl-tax'): {{ core()->formatPrice($item->price, $shipment->order->order_currency_code) }}</span>
                            @else
