    ...
    <div id="registration-wizard" class="animate-in fade-in slide-in-from-bottom-4 duration-1000">
        ...
        <div class="mb-10">
            <a href="{{ route('shop.customer.session.index') }}" 
                class="inline-flex items-center gap-2 px-5 py-2.5 bg-white/5 border border-white/10 rounded-xl text-[10px] font-black uppercase tracking-widest text-zinc-400 hover:text-white hover:bg-white/10 transition-all group">
        ...
        <div class="mb-12 text-center">
            <h1 class="text-4xl font-black text-white mb-4 uppercase tracking-tighter leading-none">Создать<br>Аккаунт</h1>
            <p class="text-sm text-zinc-400 font-bold uppercase tracking-wider leading-relaxed">
        ...
        <div class="w-full mb-10 group">
            <div class="relative h-20 bg-white/5 border border-white/10 rounded-2xl group-focus-within:border-[#7C45F5]/50 group-focus-within:bg-[#7C45F5]/5 transition-all duration-300">
                <div class="absolute inset-y-0 left-6 flex items-center pointer-events-none">
                    <span class="text-xs font-black text-zinc-500 uppercase tracking-widest group-focus-within:text-[#7C45F5] transition-colors">Никнейм</span>
                </div>
                
                <div class="h-full flex items-center px-6 pt-1">
                    <div class="flex-grow flex items-center justify-end relative">
                        <span class="text-white/30 mr-1 text-2xl select-none font-black italic">@</span>
                        <input type="text" id="nickname-input" required
                            class="w-full text-right outline-none bg-transparent text-white font-black text-2xl tracking-tight placeholder:text-white/10"
            ...
            <p id="nickname-status" class="text-[10px] mt-4 text-center font-black uppercase tracking-widest min-h-[16px] transition-opacity duration-200 opacity-0"></p>
        </div>

        <!-- Create Button -->
        <button type="button" id="start-registration-btn" onclick="handlePasskeyRegistration(event)" disabled
            class="group relative flex w-full items-center justify-center gap-4 bg-[#7C45F5] text-white h-16 font-black uppercase tracking-[0.2em] text-sm transition-all hover:bg-[#8A5CF7] shadow-lg shadow-[#7C45F5]/20 active:scale-[0.98] rounded-2xl overflow-hidden disabled:opacity-30 disabled:cursor-not-allowed mb-8">
        ...
        <p class="text-center text-[10px] text-zinc-500 font-bold uppercase tracking-[0.15em] leading-relaxed max-w-[320px] mx-auto">
            Нажимая кнопку, вы подтверждаете согласие с <a href="#" class="text-white/40 underline underline-offset-4 decoration-white/10 hover:text-white transition-colors">правилами сервиса</a>.
        </p>
    </div>
