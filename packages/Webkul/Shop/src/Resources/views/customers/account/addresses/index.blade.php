<x-shop::layouts.account :show-back="false">
    ...
    <x-slot:title></x-slot>
        ...
        <div class="flex-auto pt-2 pb-8">
            <!-- Tiled Header -->
            <div
                class="bg-white border border-gray-100 flex items-center justify-between gap-3 px-5 py-4 border-b mb-6">
                <h1 class="text-[20px] font-bold text-zinc-900 leading-tight">
                    @lang('shop::app.customers.account.addresses.index.title')</h1>
