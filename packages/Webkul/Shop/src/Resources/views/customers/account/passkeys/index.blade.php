<x-shop::layouts.account>
    ...
    <x-slot:title>
        ...
        <div class="flex-auto">
            ...
            <div class="px-8 max-md:px-5 mt-4">
                ...
                <div class="mt-8">
                    ...
                    <div class="bg-zinc-50 border border-zinc-100 rounded-[14px] overflow-hidden">
                        ...
                        @else
                            <div class="px-5 py-8 text-center bg-white/50">
                                <p class="text-[15px] text-zinc-500 mb-2">У вас пока нет привязанных Passkey устройств.</p>
                                <p class="text-xs text-zinc-400">Добавьте устройство (отпечаток или FaceID) для быстрого
                                    входа без пароля и подтверждений по почте.</p>
                            </div>
                        @endif

                        <div class="p-4 bg-white/50 border-t border-zinc-100">
                            <button type="button" id="add-passkey-button" onclick="window.startPasskeyRegistration()"
                                class="flex w-full items-center justify-center gap-2 rounded-xl border border-zinc-200 bg-white py-3 text-sm font-medium text-zinc-700 transition hover:bg-zinc-50 disabled:opacity-50">
