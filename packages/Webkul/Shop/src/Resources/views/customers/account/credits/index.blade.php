        ...
        <div class="max-w-lg mx-auto px-4 py-12">
            ...
            <div id="step-add-organization" class="hidden bg-white border border-zinc-100 shadow-sm p-6 md:p-8">
                <x-shop::form :action="route('shop.customers.account.organizations.store')"
                    @submit="document.getElementById('org-submit-btn').disabled = true; document.getElementById('org-submit-btn').innerHTML = 'Сохранение...'">
        ...
        @push('scripts')
            <script>
                ...
                function switchStep(newStep) {
                    ['step-dashboard', 'step-transactions', 'step-details', 'step-management', 'step-add-wallet', 'step-empty', 'step-deposit-type', 'step-b2b-management', 'step-add-organization'].forEach(id => {
