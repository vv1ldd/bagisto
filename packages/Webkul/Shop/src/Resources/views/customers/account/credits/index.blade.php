                    ...
                    <div class="space-y-4">
                        ...
                        @if($defaultBillingEntity)
                            <div class="p-4 bg-zinc-50 border border-zinc-100">
                                <span class="text-[11px] text-zinc-400 font-bold uppercase tracking-widest block mb-1">
                                    @lang('shop::app.customers.account.topup.select-billing-entity')
                                </span>
                                <div class="text-[15px] font-bold text-zinc-900">
                                    {{ $defaultBillingEntity->name }}
                                </div>
                                <div class="text-[12px] text-zinc-500">
                                    ИНН: {{ $defaultBillingEntity->inn }}
                                </div>
                                <input type="hidden" id="topup-billing-entity" value="{{ $defaultBillingEntity->id }}">
                            </div>
                        @else
                            <x-shop::form.control-group>
                                <x-shop::form.control-group.label
