            ...
            <div class="mt-8">
                <a href="{{ route('shop.customers.account.credits.transactions') }}" 
                    ...
                    <div class="flex items-center gap-4">
                        <div class="w-10 h-10 rounded-xl bg-zinc-50 flex items-center justify-center text-zinc-400 group-hover:bg-violet-50 group-hover:text-violet-600 transition-colors">
                    ...
                    <svg xmlns="http://www.w3.org/2000/svg" class="w-5 h-5 text-zinc-300 group-hover:text-violet-400 transition-all transform group-hover:translate-x-1" fill="none" viewBox="0 0 24 24" stroke="currentColor">
