                            ...
                            <div class="flex items-center gap-4">
                                ...
                                <div class="flex-1 min-w-0">
                                    <div class="flex items-center gap-1.5 group/alias">
                                        ...
                                        <svg xmlns="http://www.w3.org/2000/svg" class="w-3 h-3 text-zinc-400 cursor-pointer hover:text-violet-500 transition-colors" viewBox="0 0 20 20" fill="currentColor"
                                             onclick="const newAlias = prompt('Введите новое название кошелька', '{{ addslashes($address->alias ?? '') }}'); if (newAlias !== null) { document.getElementById('update-alias-form-{{ $address->id }}').querySelector('input[name=alias]').value = newAlias; document.getElementById('update-alias-form-{{ $address->id }}').submit(); }">
