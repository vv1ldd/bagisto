<x-shop::layouts.auth title="Фраза восстановления" contentWidth="max-w-[480px]">
    <x-slot:header>
        ...
        <div class="space-y-5">
            <seed-phrase-reveal :words='@json($words)'
                verify-url="{{ route('shop.customers.account.profile.verify_recovery_key') }}"></seed-phrase-reveal>
        </div>
