...
>
    ...
    <div class="space-y-8" x-data="{ step: 1 }">
        ...
        <div class="flex flex-col gap-6">
            {{-- Step 1 Block --}}
            <div x-show="step === 1" class="grid grid-cols-3 gap-3 w-full" x-transition.opacity.scale.95>
            ...
            <div x-show="step === 1" class="flex justify-center pt-4">
            ...
            {{-- Step 2 Block --}}
            <div x-show="step === 2" class="grid grid-cols-3 gap-3 w-full" x-transition.opacity.scale.95>
                @foreach($words as $index => $word)
                    @if($index >= $splitIndex)
        ...
        <div class="flex flex-col items-center gap-8 pt-4" x-show="step === 2" x-transition.opacity.delay.300>
