    ...
    >
        {!! view_render_event('bagisto.shop.settings.gdpr.modal.cookie.before') !!}
            ...
            @if (core()->getConfigData('general.gdpr.cookie.enabled'))
                <div
                    class="js-cookie-consent fixed z-[999] mx-4 box-border hidden min-h-5 overflow-hidden  bg-black/90 p-7"
                ...
                >
                    ...
                    <div class="cookieButton">
                        <div class="mt-2.5 flex gap-2">
                            <button
                                class="box-border inline-block w-full cursor-pointer  bg-[#7C45F5]/100 px-6 py-4 text-center font-sans text-sm font-bold text-white transition-colors duration-300 ease-in-out hover:bg-blue-400 hover:text-white"
                                @click="createCookie()"
                            >
                        ...
                        <a
                            class="mt-2.5 box-border inline-block w-full cursor-pointer  bg-[#7C45F5]/100 px-6 py-4 text-center font-sans text-sm font-bold text-white transition-colors duration-300 ease-in-out hover:bg-blue-400 hover:text-white"
