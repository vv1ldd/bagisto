...
<div class="relative w-full max-w-[500px] mx-auto px-4 mt-2 mb-10">
    ...
    <div class="flex items-center gap-3 mb-6 px-0 pt-0">
        <button type="button" 
            ...
            onclick="const referrer = document.referrer; if (referrer && !referrer.includes('/account')) { window.location.href = referrer; } else { window.location.href = '{{ route('shop.home.index') }}'; }"
