@php
    $showCategories = !(request()->is('search*') || request()->is('category*') || request()->routeIs('shop.search.index') || request()->routeIs('shop.product_or_category.index'));
@endphp
...
<div class="flex min-h-[64px] w-full justify-between px-8 max-sm:px-4 mx-auto max-w-7xl">
    ...
    <div class="flex items-center gap-x-10 max-[1180px]:gap-x-5">
        ...
        <div class="flex items-center gap-5">
            ...
            {{-- Teleport target for catalog filters/toolbar — now always present if categories are not forced --}}
            <div id="header-toolbar-teleport-target" class="flex-1"></div>
        </div>
            ...
            @else
                <div
                    ...
                    <a href="{{ route('shop.customers.account.index') }}"
                        class="text-sm font-medium text-zinc-700 hover:text-[#7C45F5] transition-colors flex items-center gap-1">
                        @
