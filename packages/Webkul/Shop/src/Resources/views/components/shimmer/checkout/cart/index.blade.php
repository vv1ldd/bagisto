...
<div class="mt-8 flex flex-wrap gap-20 max-1060:flex-col max-sm:mt-0 max-sm:gap-[30px]">
    <div class="grid flex-1 gap-y-6">
        <!-- Cart Action -->
        <div class="flex items-center justify-between border-b border-zinc-200 dark:border-white/5 pb-2.5 max-sm:justify-normal max-sm:gap-5 max-sm:py-2.5">
        ...
        <!-- Cart Items -->
        @for ($i = 0; $i < $count; $i++)
            <div class="flex justify-between gap-x-2.5 border-b border-zinc-200 dark:border-white/5 pb-5">
