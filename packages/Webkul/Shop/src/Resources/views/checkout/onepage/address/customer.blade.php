                                                                            ...
                                                                            <div v-if="! activeAddressForm">
                                                                                ...
                                                                                >
                                                                                    ...
                                                                                    <div class="relative flex items-center justify-between">
                                                                                        <div class="min-w-0">
                                                                                            <p class="text-lg font-bold transition-colors duration-300" :class="[selectedOrgId === null ? 'text-[#7C45F5]' : 'text-zinc-800']">
                                                                                                @{{ customerFullName }}
                                                                                            </p>
                                                                                ...
                                                                                <div v-if="organizations.length" class="mb-8 animate-[fadeIn_0.3s_ease-out]">
                                                                                    ...
                                                                                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                                                                        ...
                                                                                        >
                                                                                            ...
                                                                                            <div class="relative flex items-center justify-between">
                                                                                                <div class="min-w-0">
                                                                                                    <p class="font-bold transition-colors duration-300" :class="[selectedOrgId == org.id ? 'text-[#7C45F5]' : 'text-zinc-800']">@{{ org.name }}</p>
                                                                                                    <div class="flex flex-wrap gap-2 mt-2">
                                                                                                        <span class="px-2 py-0.5 rounded-md bg-zinc-100/50 text-[10px] font-bold text-zinc-500 uppercase tracking-wider">ИНН @{{ org.inn }}</span>
                                                                                                        <span v-if="org.kpp" class="px-2 py-0.5 rounded-md bg-zinc-100/50 text-[10px] font-bold text-zinc-500 uppercase tracking-wider">КПП @{{ org.kpp }}</span>
                                                                                                    </div>
                                                                                                </div>
                                                                                ...
                                                                                <div class="mt-12 flex justify-center">
                                                                                    <x-shop::button
                                                                                        class="primary-button group relative flex items-center gap-3 overflow-hidden rounded-full bg-[#7C45F5] px-16 py-5 text-xl font-bold transition-all hover:bg-[#6b35e4] hover:shadow-[0_8px_30px_rgb(124,69,245,0.4)] active:scale-95 disabled:opacity-50"
