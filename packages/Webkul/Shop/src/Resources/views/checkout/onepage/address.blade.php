...
<x-shop::accordion
    class="mb-7 mt-8 overflow-hidden rounded-2xl border border-white/40 bg-white/40 backdrop-blur-3xl shadow-sm !border-b-0 max-md:mb-4 max-md:mt-4">
    <!-- Accordion Header Component Slot -->
    <x-slot:header v-if="cart.have_stockable_items"
