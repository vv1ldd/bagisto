                                ...
                                <div class="mb-4">
                                    <x-shop::form.control-group class="!mb-0 flex items-center gap-2.5">
                                        ...
                                        <label class="cursor-pointer select-none text-base text-zinc-500 max-md:text-sm max-sm:text-xs" for="is_gift">
                                            @{{ trans('shop::app.checkout.onepage.address.is-gift') || 'Это подарок' }}
                                        </label>
                                    </x-shop::form.control-group>
                                    ...
                                    <div v-if="isGift" class="mt-4">
                                        <x-shop::form.control-group>
                                            <x-shop::form.control-group.label class="required">
                                                @{{ trans('shop::app.checkout.onepage.address.gift-email') || 'Email получателя' }}
                                            </x-shop::form.control-group.label>
                                            <x-shop::form.control-group.control
                                                type="email"
                                                ...
                                                v-model="giftEmail"
                                                rules="required|email"
                                                ::label="trans('shop::app.checkout.onepage.address.gift-email') || 'Email получателя'"
