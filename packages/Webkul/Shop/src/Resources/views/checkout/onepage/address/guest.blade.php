        ...
        <form @submit="handleSubmit($event, addAddress)">
            ...
            <div class="mb-4">
                ...
                <v-checkout-address-form control-name="billing"
                    :address="cart.billing_address || undefined"></v-checkout-address-form>
            ...
            <div class="mt-4 flex justify-end">
                <x-shop::button
                    class="primary-button rounded-[5px] px-11 py-3 max-md:w-full max-md:max-w-full max-md:rounded-lg"
                    :title="trans('shop::app.checkout.onepage.address.proceed')" ::loading="isStoring"
                    ::disabled="isStoring" />
            </div>
        </form>
    </x-shop::form>
