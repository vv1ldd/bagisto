    ...
    <div class="px-4 py-3 sm:px-8 sm:py-6 max-w-7xl mx-auto" v-cloak>
        <div class="flex items-center justify-between mb-6">
            <a href="{{ route('shop.home.index') }}" class="group flex items-center gap-2">
                <span class="text-2xl font-black tracking-tighter text-[#7C45F5] transition-transform group-hover:scale-105">MEANLY</span>
            </a>

            @guest('customer')
                @include('shop::checkout.login')
            @else
                <div class="flex items-center gap-2.5 px-3 py-1.5 rounded-full bg-white/60 border border-white/80 backdrop-blur-md shadow-sm">
                    <div class="h-7 w-7 rounded-full bg-[#7C45F5] text-white flex items-center justify-center text-[10px] font-black uppercase ring-2 ring-white">
