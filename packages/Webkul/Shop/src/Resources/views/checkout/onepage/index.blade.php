<x-shop::layouts :has-feature="false" :has-footer="false">
    ...
    @pushOnce('scripts')
        <script type="text/x-template" id="v-checkout-template">
            ...
            <template v-else>
                <!-- Brutalist step breadcrumb inside component to access currentStep -->
                <div class="border-b-4 border-zinc-900 bg-white shadow-[0_4px_0px_0px_rgba(24,24,27,1)] mb-10">
