...
<x-shop::layouts :has-header="false" :has-feature="false" :has-footer="false">
    ...
    <x-slot:title>
        ...
        <!-- Page Header -->
        <div class="flex-wrap">
            <div class="flex w-full items-center justify-between px-[60px] py-6 max-lg:px-8 max-sm:px-4">
                <!-- Logo -->
                ...
                <div class="absolute left-1/2 -translate-x-1/2 max-md:hidden">
                    <div class="rounded-full border border-white/60 bg-white/40 px-6 py-2 backdrop-blur-md shadow-sm">
                ...
                <div class="flex items-center gap-4">
                    ...
                    @else
                        <div
                            ...
                            <div
                                class="flex h-8 w-8 items-center justify-center rounded-full bg-[#7C45F5] text-white font-bold text-xs">
                                {{ substr(auth()->guard('customer')->user()->first_name, 0, 1) }}
                            </div>
                            <span
                                class="text-sm font-medium text-zinc-700">{{ auth()->guard('customer')->user()->first_name }}</span>
                        </div>
                    @endguest
                </div>
            </div>
