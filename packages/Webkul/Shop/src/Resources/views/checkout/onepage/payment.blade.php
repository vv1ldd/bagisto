                                        ...
                                        <template v-else>
                                            ...
                                            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                                ...
                                                >
                                                    ...
                                                    <!-- Crypto Selection for Wallet -->
                                                    <div v-if="payment.method === 'credits' && $parent.selectedPaymentMethod === 'credits'" class="relative mt-6 w-full animate-[fadeIn_0.3s_ease-out] p-4 rounded-xl bg-[#7C45F5]/5 border border-[#7C45F5]/10">
                                                        <label class="block text-[10px] font-black text-[#7C45F5] uppercase tracking-widest mb-3">Выберите монету для оплаты</label>

                                                        <div class="relative group/select">
                                                            <select 
                                                                name="payment[crypto_coin]" 
                                                                class="block w-full appearance-none rounded-xl border border-white bg-white px-4 py-3 text-sm font-bold text-zinc-800 shadow-sm focus:border-[#7C45F5] focus:outline-none focus:ring-2 focus:ring-[#7C45F5]/20 transition-all cursor-pointer"
                                                        ...
                                                        <div class="mt-4 flex items-start gap-2">
                                                            <span class="icon-information text-zinc-400 text-sm mt-0.5"></span>
                                                            <p class="text-[10px] font-medium text-zinc-500 leading-tight">
                                                                Окончательная сумма будет рассчитана по актуальному курсу при подтверждении через Passkey.
                                                            </p>
                                                        </div>
                                                    </div>
                                                </div>
