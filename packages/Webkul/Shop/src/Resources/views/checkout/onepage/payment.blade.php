    ...
    <script type="text/x-template" id="v-payment-methods-template">
                <div class="mb-7 max-md:last:!mb-0">
                    ...
                    <template v-else>
                        ...
                        <x-shop::accordion class="mb-7 overflow-hidden rounded-2xl border border-white/40 bg-white/40 backdrop-blur-3xl shadow-sm !border-b-0 max-md:mb-4">
                            ...
                            <x-slot:content class="mt-8 !p-0 max-md:mt-0 max-md:rounded-t-none max-md:border max-md:border-t-0 max-md:!p-4">
                                <div class="flex flex-wrap gap-7 max-md:gap-4 max-sm:gap-2.5">
                                    ...
                                    >
                                        ...
                                        <label 
                                            :for="payment.method" 
                                            class="block w-[190px] cursor-pointer rounded-[5px] border border-white/20 bg-white/5 p-5 max-md:flex max-md:w-full max-md:gap-5 max-md:rounded-lg max-sm:gap-4 max-sm:px-4 max-sm:py-2.5"
                                        >
                                        ...
                                        <div v-if="payment.method === 'credits' && $parent.selectedPaymentMethod === 'credits'" class="w-full mt-3 px-1">
                                            ...
                                            <select 
                                                ...
                                                class="block w-full rounded-[5px] border-white/20 bg-white/5 shadow-sm focus:border-[#7C45F5] focus:ring-[#7C45F5] sm:text-sm p-2 border transition-all"
