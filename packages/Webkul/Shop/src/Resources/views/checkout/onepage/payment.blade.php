                                                ...
                                                <div v-if="payment.method === 'credits' && $parent.selectedPaymentMethod === 'credits'" class="relative mt-6 w-full animate-[fadeIn_0.3s_ease-out]">
                                                    ...
                                                    <div class="relative">
                                                        <select 
                                                            ...
                                                            class="block w-full appearance-none rounded-xl border border-[#7C45F5]/20 bg-white px-4 py-2.5 text-xs font-bold text-zinc-800 focus:border-[#7C45F5] focus:outline-none focus:ring-1 focus:ring-[#7C45F5] transition-all"
