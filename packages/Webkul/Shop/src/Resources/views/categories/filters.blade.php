                                                                                        ...
                                                                                        <template v-else>
                                                                                            <div class="sticky top-0 z-[100] flex items-center gap-4 overflow-x-auto border-b border-white/10 bg-white/10 backdrop-blur-2xl py-3 no-scrollbar px-4 md:px-0">
                                                                                                        ...
                                                                                                        <div class="flex-shrink-0 min-w-[180px] md:min-w-[240px]">
                                                                                                            <form action="{{ route('shop.search.index') }}" class="relative group">
                                                                                                                ...
                                                                                                                <input
                                                                                                                    ...
                                                                                                                    value="{{ request('query') }}"
                                                                                                                    placeholder="Поиск..."
                                                                                                                    class="w-full rounded-full border border-white/20 bg-white/20 py-2 pl-11 pr-4 text-sm font-medium text-zinc-700 transition-all hover:border-[#7C45F5] focus:border-[#7C45F5] focus:outline-none focus:ring-4 focus:ring-[#7C45F5]/10"
                                                                                                            ...
                                                                                                            >
                                                                                                                ...
                                                                                                                <button
                                                                                                                    ...
                                                                                                                    :class="isFilterApplied(filter)
                                                                                                                        ...
                                                                                                                        : 'border-white/20 bg-white/20 text-zinc-700 hover:border-[#7C45F5] hover:text-[#7C45F5]'"
                                                                                                        ...
                                                                                                        <div class="flex items-center gap-3">
                                                                                                            ...
                                                                                                            <div class="flex items-center rounded-full border border-white/20 bg-white/10 p-0.5 max-md:hidden">
                                                                                                                <button
                                                                                                                    type="button"
