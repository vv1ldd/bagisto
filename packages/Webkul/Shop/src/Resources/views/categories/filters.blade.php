...
@pushOnce('scripts')
    ...
    <script type="text/x-template" id="v-filters-template">
                                                                                                    ...
                                                                                                    {{-- Horizontal filter bar --}}
                                                                                                     <template v-else>
                                                                                                         <div class="sticky top-4 z-[100] mx-4 mb-4 rounded-3xl border border-[#E8E4FF] bg-[#F8F7FF]/80 py-3 shadow-lg shadow-[#7C45F5]/5 backdrop-blur-xl no-scrollbar overflow-x-auto transition-all">
