                                                                                                        ...
                                                                                                        <div 
                                                                                                            ...
                                                                                                            :class="[
                                                                                                                !isTeleportTargetAvailable 
                                                                                                                    ...
                                                                                                                    : 'w-full px-0 py-0 flex items-center justify-center h-10'
                                                                                                            ]"
                                                                                                        >
                                                                                                            <div 
                                                                                                                class="flex items-center flex-nowrap transition-all h-full"
                                                                                                                :class="isTeleportTargetAvailable ? 'w-full gap-2 items-center justify-center' : 'max-w-7xl mx-auto gap-4'"
                                                                                                            >
                                                                                                                {{-- SEARCH: Box-style search input --}}
                                                                                                                <div 
                                                                                                                    class="flex-shrink-0 transition-all flex items-center h-full"
                                                                                                                    :class="[
                                                                                                                        isTeleportTargetAvailable ? 'max-w-[200px]' : 'min-w-[180px] md:min-w-[240px]',
                                                                                                                    ]"
                                                                                                                >
                                                                                                                    <form action="{{ route('shop.search.index') }}" class="relative group w-full flex items-center h-full">
                                                                                                                        <div class="relative w-full h-full">
                                                                                                                            ...
                                                                                                                            <input
                                                                                                                                ...
                                                                                                                                value="{{ request('query') }}"
                                                                                                                                placeholder="Поиск..."
                                                                                                                                class="block w-full h-full !rounded-none border border-zinc-200 bg-white font-medium text-zinc-700 transition-all focus:border-[#7C45F5] focus:outline-none focus:ring-0"
                                                                                                                                :class="isTeleportTargetAvailable ? 'pl-11 pr-2 text-[13px]' : 'py-2 pl-12 pr-4 text-sm font-medium'"
                                                                                                                    ...
                                                                                                                    >
                                                                                                                        <button
                                                                                                                            ...
                                                                                                                            :class="[
                                                                                                                                ...
                                                                                                                                isTeleportTargetAvailable ? 'px-3 text-[12px]' : 'px-4 text-sm'
                                                                                                                            ]"
                                                                                                                    ...
                                                                                                                    <div class="flex items-center gap-1.5 h-full ml-1" v-if="!isMobile">
                                                                                                                        <button
                                                                                                                            ...
                                                                                                                            :class="[
                                                                                                                                ...
                                                                                                                                isTeleportTargetAvailable ? 'px-2.5 text-[12px]' : 'px-3 text-xs'
                                                                                                                            ]"
