...
@pushOnce('scripts')
    ...
    <script type="text/x-template" id="v-filters-template">
                                                                                            ...
                                                                                            <template v-else>
                                                                                                <div class="sticky top-0 z-[100] flex items-center gap-4 overflow-x-auto border-b border-white/10 bg-white/10 backdrop-blur-2xl py-3 no-scrollbar px-4 md:px-0">
                                                                                                            ...
                                                                                                            <div class="flex-shrink-0 min-w-[180px] md:min-w-[240px]">
                                                                                                                <form action="{{ route('shop.search.index') }}" class="relative group">
                                                                                                                    ...
                                                                                                                    <input
                                                                                                                        ...
                                                                                                                        value="{{ request('query') }}"
                                                                                                                        placeholder="Поиск..."
                                                                                                                        class="w-full rounded-[5px] border border-white/10 bg-white/5 py-2 pl-11 pr-4 text-sm font-medium text-zinc-700 transition-all hover:border-[#7C45F5] focus:border-[#7C45F5] focus:outline-none focus:ring-4 focus:ring-[#7C45F5]/10"
                                                                                                            ...
                                                                                                            <div class="flex items-center gap-2">
                                                                                                                ...
                                                                                                                >
                                                                                                                    ...
                                                                                                                    <button
                                                                                                                        type="button"
                                                                                                                        class="flex items-center gap-1.5 rounded-[5px] border px-4 py-2 text-sm font-medium transition-colors"
                                                                                                                        :class="isFilterApplied(filter)
                                                                                                                            ? 'border-[#7C45F5] bg-[#7C45F5]/10 text-[#7C45F5]'
                                                                                                                            : 'border-white/10 bg-white/10 text-zinc-700 hover:border-[#7C45F5] hover:text-[#7C45F5]'"
                                                                                                                ...
                                                                                                                <button
                                                                                                                    ...
                                                                                                                    class="flex items-center gap-1 rounded-[5px] border border-red-200 px-3 py-2 text-sm font-medium text-red-500 transition hover:bg-red-50/50"
                                                                                                                    @click="clear()"
                                                                                                                >
                                                                                                            ...
                                                                                                            <div class="flex items-center gap-3">
                                                                                                                ...
                                                                                                                <div class="flex items-center gap-1.5 max-md:hidden">
                                                                                                                    <button
                                                                                                                        ...
                                                                                                                        :key="sort.value"
                                                                                                                        type="button"
                                                                                                                        class="flex items-center gap-1 rounded-[5px] border px-3 py-1.5 text-xs font-medium transition-colors whitespace-nowrap"
                                                                                                                        :class="sort.value === currentSort
                                                                                                                            ? 'border-[#7C45F5] bg-[#7C45F5]/10 text-[#7C45F5]'
                                                                                                                            : 'border-white/10 bg-white/10 text-zinc-500 hover:border-[#7C45F5] hover:text-[#7C45F5]'"
                                                                                                                ...
                                                                                                                <div class="flex items-center rounded-[5px] border border-white/10 bg-transparent p-0.5 max-md:hidden">
                                                                                                                    <button
                                                                                                                        type="button"
                                                                                                                        class="rounded-[5px] px-3 py-1.5 transition"
