...
@pushOnce('scripts')
    ...
    <script type="text/x-template" id="v-filters-template">
                                                                                    ...
                                                                                    <template v-else>
                                                                                        <div class="sticky top-0 z-[100] flex items-center gap-4 overflow-x-auto border-b border-white/20 bg-white/40 backdrop-blur-3xl py-3 no-scrollbar px-4 md:px-0">
