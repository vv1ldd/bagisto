                    ...
                    >
                        ...
                        >
                            ...
                            <div 
                                ...
                                :class="isTeleportTargetAvailable ? 'w-[120px]' : 'min-w-[180px] md:min-w-[240px]'"
                            >
                                <form action="{{ route('shop.search.index') }}" class="relative group">
                                    ...
                                    <input
                                        ...
                                        :class="isTeleportTargetAvailable ? 'py-1 pl-7 pr-2 text-[11px]' : 'py-1.5 pl-9 pr-4 text-sm font-medium'"
                                ...
                                >
                                    ...
                                    <button
                                        ...
                                        :class="[
                                            ...
                                            isTeleportTargetAvailable ? 'px-2 py-1 text-[11px]' : 'px-4 py-2.5 text-sm'
                                        ]"
                                    ...
                                    >
                                        ...
                                        <button
                                            ...
                                            class="flex items-center gap-1 border border-red-200 bg-white text-red-500 transition-all hover:bg-red-50 active:scale-[0.98] shadow-sm whitespace-nowrap"
                                            :class="[
                                                isTeleportTargetAvailable ? 'rounded-xl px-2 py-1 text-[11px] font-bold' : 'rounded-2xl px-4 py-2.5 text-sm font-bold'
                                            ]"
                                            @click="clear()"
                                        >
                                        ...
                                        >
                                            <button
                                                ...
                                                :class="[
                                                    ...
                                                    isTeleportTargetAvailable ? 'px-2 py-1 text-[11px]' : 'px-3 py-1.5 text-xs'
                                                ]"
