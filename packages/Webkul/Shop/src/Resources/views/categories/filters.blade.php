                    ...
                    <Teleport to="#header-toolbar-teleport-target" :disabled="!isTeleportTargetAvailable">
                        <div 
                            :class="{
                                ...
                                'w-full py-1.5': isTeleportTargetAvailable
                            }"
                            class="no-scrollbar overflow-x-auto transition-all"
                        >
                            <div 
                                class="max-w-7xl mx-auto flex items-center transition-all"
                                :class="isTeleportTargetAvailable ? 'gap-2 px-0' : 'gap-4 px-6'"
                            >
                                {{-- SEARCH: Pill-style search input --}}
                                <div 
                                    class="flex-shrink-0 transition-all"
                                    :class="isTeleportTargetAvailable ? 'w-[160px]' : 'min-w-[180px] md:min-w-[240px]'"
                                >
                                    <form action="{{ route('shop.search.index') }}" class="relative group">
                                        <span class="icon-search absolute left-3 top-1/2 -translate-y-1/2 text-lg text-zinc-400 group-hover:text-[#7C45F5] transition-colors"></span>
                                        <input
                                            type="text"
                                            name="query"
                                            value="{{ request('query') }}"
                                            placeholder="Поиск..."
                                            class="w-full rounded-xl border border-white bg-white/50 py-1.5 pl-9 pr-4 text-sm font-medium text-zinc-700 transition-all hover:border-[#7C45F5] focus:border-[#7C45F5] focus:outline-none shadow-sm"
                                ...
                                <div class="flex items-center gap-1.5">
                                    ...
                                    >
                                        ...
                                        <button
                                            type="button"
                                            class="flex items-center gap-1.5 rounded-xl border font-semibold transition-all active:scale-[0.98]"
                                            :class="[
                                                ...
                                                isTeleportTargetAvailable ? 'px-3 py-1.5 text-xs' : 'px-4 py-2.5 text-sm'
                                            ]"
                                    ...
                                    <button
                                        ...
                                        class="flex items-center gap-1 border border-red-200 bg-white text-red-500 transition-all hover:bg-red-50 active:scale-[0.98] shadow-sm"
                                        :class="[
                                            isTeleportTargetAvailable ? 'rounded-xl px-3 py-1.5 text-xs font-bold' : 'rounded-2xl px-4 py-2.5 text-sm font-bold'
                                        ]"
                                        @click="clear()"
                                    >
                                        <span class="icon-cross" :class="isTeleportTargetAvailable ? 'text-xs' : 'text-sm'"></span>
                                ...
                                <div class="flex items-center gap-2 ml-auto">
                                    ...
                                    <div 
                                        class="flex items-center rounded-xl border border-[#E8E4FF] bg-white p-0.5 max-md:hidden shadow-sm"
                                        :class="isTeleportTargetAvailable ? 'scale-90' : ''"
                                    >
                                        <button
                                            type="button"
                                            class="rounded-lg px-3 py-1.5 transition-all active:scale-[0.95]"
                                        ...
                                        >
                                            <span class="text-lg" :class="currentMode === 'list' ? 'icon-listing-fill' : 'icon-listing'"></span>
                                        </button>
                                        <button
                                            type="button"
                                            class="rounded-lg px-3 py-1.5 transition-all active:scale-[0.95]"
                                        ...
                                        >
                                            <span class="text-lg" :class="currentMode === 'grid' ? 'icon-grid-view-fill' : 'icon-grid-view'"></span>
                                        </button>
                                    </div>
                                </div>
                            </div>
