        ...
        configure({
            ...
            generateMessage: localize({
                ...
                ru: {
                    ...
                    messages: {
                        ...ru.messages,
                        required: (ctx) => `${ctx.field.replace('Поле ', '')} обязательно для заполнения`,
                        required_if: (ctx) => `${ctx.field.replace('Поле ', '')} обязательно для заполнения`,
                        min: (ctx) => `${ctx.field.replace('Поле ', '')} должно быть не короче ${ctx.params.length} символов`,
                        max: (ctx) => `${ctx.field.replace('Поле ', '')} не может быть длиннее ${ctx.params.length} символов`,
                        phone: (ctx) => `Это ${ctx.field.replace('Поле ', '')} должно быть действительным номером телефона`,
                        address: (ctx) => `Это ${ctx.field.replace('Поле ', '')} должно быть действительным адресом`,
                    },
                },
