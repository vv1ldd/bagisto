...
return [
    ...
    'emails' => [
        ...
        'customers' => [
            ...
            'topup' => [
                'subject' => 'Счет на оплату пополнения №:id',
                'greeting' => 'Ваш запрос на пополнение кошелька принят.',
                'description' => 'Был создан запрос на пополнение кошелька на сумму :amount. Счет на оплату в формате PDF прикреплен к этому письму.',
