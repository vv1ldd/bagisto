...
return [
    'customers' => [
        ...
        'login-form' => [
            ...
            'or' => 'ИЛИ',
            'back-to-login-options' => 'Вернуться к способам входа',
        ],
        ...
        'signup-form' => [
            ...
            'email' => 'Электронная почта',
            'agreement' => 'Нажимая «Создать аккаунт», вы соглашаетесь на обработку персональных данных.',
            'first-name' => 'Имя',
            'footer' => '© :current_year MEANLY. Все права защищены.',
        ...
        'account' => [
            ...
            'credits' => [
                'unlock-via-menu' => 'Пожалуйста, разблокируйте кошелек через меню профиля.',
            ],

            'topup' => [
                'amount' => 'Сумма пополнения',
                'select-billing-entity' => 'Организация-получатель',
                'generate-invoice' => 'Выставить счет на оплату',
                'success' => 'Запрос на пополнение успешно создан.',
                'pending-message' => 'Ваш запрос ожидает оплаты. Пожалуйста, скачайте счет и произведите платеж.',
                'download-invoice' => 'Скачать счет на оплату',
                'title' => 'Счет на оплату пополнения',
            ],
            ...
            'organizations' => [
                'index' => [
                    ...
                    'edit' => 'Редактировать',
                    'edit-success' => 'Организация успешно обновлена.',
                    'empty-organization' => 'Вы еще не добавили организацию в свою учетную запись.',
                    'title' => 'Организации',
    ...
    'checkout' => [
        ...
        'onepage' => [
            'address' => [
                ...
                'otp-sent' => 'Код отправлен на ваш Email',
                'invalid-otp' => 'Неверный код, попробуйте еще раз',
                'selection-title' => 'Выберите способ оформления',
            ],
    ...
    'emails' => [
        ...
        'customers' => [
            ...
            'verification' => [
                'description' => 'Пожалуйста, подтвердите ваш адрес электронной почты для получения цифровых товаров и уведомлений безопасности.',
                'greeting' => 'Добро пожаловать в MEANLY!',
            ...
            'invoice' => [
                'subject' => 'Счет-Оферта №:id от :date',
                'greeting' => 'Ваш запрос на формирование счета принят.',
                'description' => 'Был сформирован запрос на оплату услуг на сумму :amount. Счет на оплату в формате PDF прикреплен к этому письму.',
                'transaction-id' => 'Номер счета',
                'amount-label' => 'Сумма',
                'footer' => 'Пожалуйста, произведите оплату по реквизитам, указанным в прикрепленном счете. После поступления средств ваш баланс будет обновлен автоматически.',
            ],
        ],
    ...
    'admin' => [
        'system' => [
            'login-page' => [
                ...
                'scheduled-image-1' => 'Запланированное изображение 1',
                'scheduled-image-2' => 'Запланированное изображение 2',
                'scheduled-image-3' => 'Запланированное изображение 3',
